...
const Sidebar: React.FC = () => {
  ...
  return (
    <motion.aside
      className={`fixed h-screen bg-gradient-to-b from-meru-black to-meru-slate/80 backdrop-blur-lg p-6 shadow-2xl transition-all duration-300 ${
    ...
    >
      <button
        className="absolute -right-3 top-6 bg-meru-red p-2 rounded-full text-meru-white hover:bg-meru-amber transition-all shadow-lg hover:shadow-meru-amber/20"
                  ...
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      `group flex items-center gap-3 px-4 py-2.5 rounded-xl transition-colors duration-200 ${
                        isActive
                          ? 'bg-meru-red/10 text-meru-amber border-l-4 border-meru-amber'
